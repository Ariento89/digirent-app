          ...
          <div className="medias">
            ...
            <div className="pagination mt-5">
              <button type="button" className="btn-arrow prev">
                <img className='m-auto' src="/images/icon/icon-caret-left-white.svg" alt="left arrow" />
              </button>
              <div className="pages">
              ...
              <button type="button" className="btn-arrow next">
                <img className='m-auto' src="/images/icon/icon-caret-right-white.svg" alt="right arrow" />
              </button>
            </div>
          </div>
        </div>
