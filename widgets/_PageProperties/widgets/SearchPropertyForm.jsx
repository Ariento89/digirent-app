  ...
  const getFormDetails = useCallback(
    () => ({
      ...
      schema: Yup.object().shape({
        ...
        rentalPrice: Yup.string().nullable().label('Rental Price'),
        availability: Yup.string().nullable().label('Availability'),
        amenities: Yup.string().nullable().label('Amenities'),
        sqft: Yup.string().nullable().label('Sqft'),
      }),
    }),
    [],
  );
