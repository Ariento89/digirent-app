...
const PropertiesSearchResult = ({ searchResultRef, properties, status, errors, location, onFiltersChanged }) => {
  // STATES
...
const [available_from, setAvailableFrom] = useState();
  ...
  useEffect(() => {
    ...
    const fetchRange = async () =>{
      ...
      var maxp = Math.max.apply(Math,types.map(function(o){return o.monthlyPrice;}))
      var minp = Math.min.apply(Math,types.map(function(o){return o.monthlyPrice;}))
      ...
      <Spinner loadingText="Searching properties..." isLoading={status === request.REQUESTING}>
        <div ref={searchResultRef} className="rental-houses">
          ...
          <p className="main-subtitle mt-1 mt-md-2 dark-gray" style={{textAlign: 'left'}}>
            {properties.length} new properties for rent in {' '}
          ...
          <div className="flex">
            <div className="flex-col">
              <div className="bg-white overflow-hidden rounded-lg w-80 col-xl-12">
                                ...
                                <li key={index}>
                                  <div className="block text-sm font-medium text-gray-700">
                                    <div className="left-section flex items-center">
                                      ...
                                      />
                                      <label className="ml-3 block text-sm font-medium text-gray-700" htmlFor={`custom-checkbox-${index}`}>{ht.name}</label>
                                    </div>
                ...
                <Accordion>
                  ...
                  <div className="grid grid-cols-8 gap-y-6 gap-x-4 mt-4">
                        <div className="sm:col-span-4">
                          <span htmlFor="minsqft" className="block text-sm font-medium text-gray-700">
                            Min Sqft
                          </span>
                          <div className="mt-1 flex rounded-md shadow-sm">
                            <input 
                        ...
                        <div className="sm:col-span-4">
                          <span htmlFor="maxsqft" className="block text-sm font-medium text-gray-700">
                            Max Sqft
                          </span>
                          <div className="mt-1 flex rounded-md shadow-sm">
                            <input 
                                  ...
                                  <div>
                                    <div className="left-section flex items-center">
                                      <input
                                        ...
                                        className="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded"
                                      />
                                      <label className="ml-3 block text-sm font-medium text-gray-700" htmlFor={`custom-checkbox-${am.name.id}`}>{am.name.title}</label>
                                    </div>
                                    <div className="right-section">20</div>
                                  </div>
                                </li>
