...
const PropertiesDetailsQuantities = ({ apartment }) => (
    ...
    <div className="row">
      <div className="col-12 col-sm-6 col-xl-6">
        <div className="item item-price">
          ...
          <p className="main-desc text-primary">€{apartment?.monthlyPrice}</p>
        </div>
        ...
        <div className="item item-price">
          ...
          <div className="divider right" />
          <p className="main-desc text-primary">€{apartment?.utilitiesPrice}</p>
        </div>
      ...
      <div className="col-12 col-sm-6 col-xl-6">
        <div className="item item-others">
          <div className="d-flex align-items-center justify-content-between">
            ...
            <p className="ml-2 main-desc dark-gray2">{apartment?.bedrooms}</p>
          </div>
          <div className="d-flex align-items-center justify-content-between ml-4">
            ...
            <p className="ml-2 main-desc dark-gray2">{apartment?.bathrooms}</p>
          </div>
        </div>
        ...
        <div className="item item-others">
          <div className="d-flex align-items-center justify-content-between">
            ...
            <p className="ml-2 main-desc dark-gray2">{apartment?.size}</p>
          </div>
          <div className="d-flex align-items-center justify-content-between ml-4">
            <img src="/images/icon/icon-couch-primary.svg" height="20" width="20" alt="icon" />
            <p className="ml-1 main-desc dark-gray2">{upperFirst(apartment?.furnishType)}</p>
          </div>
        </div>
        ...
        <div className="item item-date">
          ...
          <p className="main-desc dark-gray2 ml-3">
            {`${formatDate(apartment?.availableFrom)} — ${formatDate(apartment?.availableTo)}`}
          </p>
        </div>
      </div>
    </div>
